...
const EachCart = ({cart}:Prop) => {
    ...
    return ( 
        <div className="flex flex-col items-start justify-start overflow-auto sm:[&::-webkit-scrollbar]:block [&::-webkit-scrollbar]:hidden scrollbar p-3 max-h-[400px] w-full h-[400px] gap-3">
            <div className="text-[16px] font-[400] rounded-sm p-4 shadow-sm w-full items-center justify-between grid grid-cols-4">
            ...
            {cart?.map(product=>(
                <div key={product.uid} className="text-[16px] font-[400] rounded-sm p-4 shadow-sm w-full items-center justify-between grid gap-4 grid-cols-4 ">
